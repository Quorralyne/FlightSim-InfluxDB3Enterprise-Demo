...
{
  ...
  "dataPath": "C:\\Users\\yourname\\OneDrive\\Documents\\influxdb_data\\flightsim",
  ...
}
```
...
```powershell
echo $([Environment]::GetFolderPath("MyDocuments") + "\influxdb_data\")
```

> Note that this file won't exists until after you've completed the setup wizard mentioned in the Setup section.
